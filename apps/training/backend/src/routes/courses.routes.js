...
const {
  listPublic, listAll, create, update, remove, createSession, updateSession, removeSession,
...
router.delete('/sessions/:id', requireRole(['SUPER_ADMIN', 'ADMIN']), removeSession);
