  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-korintek-tealLighter px-4">
      <div className="w-full max-w-sm">
        <div className="flex justify-center mb-8"><Logo size={52} /></div>
        <div className="bg-white rounded-2xl shadow-card border border-slate-100 p-8 text-center">
          <h1 className="font-heading font-bold text-lg text-korintek-ink mb-1">Espace équipe</h1>
          <p className="text-sm text-slate-400 mb-8">Gestion des inscriptions et attestations</p>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 hover:border-korintek-teal text-slate-700 font-medium rounded-xl py-3 transition-all disabled:opacity-60"
          >
