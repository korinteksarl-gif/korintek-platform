...
export default function Login() {
  ...
  async function handleLocalLogin(e) {
    ...
    try {
      ...
      localStorage.setItem('korintek_compta_token', data.token);
    ...
    <div className="min-h-screen bg-korintek-tealLighter flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-card p-8">
          ...
          <p className="text-sm text-slate-500 text-center mb-6">Connectez-vous pour accéder à la comptabilité</p>
