...
const ROLES = ['PENDING', 'SUPER_ADMIN', 'ADMIN', 'RECEPTION', 'EXAM_CENTER_AGENT', 'FINANCE', 'TRAINER'];
const ROLE_LABELS = {
  PENDING: 'En attente d\'attribution',
  SUPER_ADMIN: 'Super administrateur',
  ADMIN: 'Administrateur',
  RECEPTION: 'Réception',
  EXAM_CENTER_AGENT: 'Agent centre d\'examen',
  FINANCE: 'Finance',
  TRAINER: 'Formateur',
};
...
export default function Users() {
  ...
  const currentUser = JSON.parse(localStorage.getItem('korintek_user') || 'null');
      ...
      <header className="bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Attribution des rôles KORINTEK ID</p>
          </div>
        </div>
